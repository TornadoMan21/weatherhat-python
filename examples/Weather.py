...
class MainView(SensorView):
 ...
 #       self.draw_info(0, 300, (20, 100, 220), "TEMP", self._data.temperature.history(), "Â°F", graph_mode=graph_mode, vmin=self._settings.minimum_temperature, vmax=self._settings.maximum_temperature)
...
#
def save_weather_data(temp_c, pressure, rain_total, wind_speed, wind_gust):
    ...
    line = f"{timestamp}, Temp_F: {temp_f:.2f}, Pressure: {pressure:.2f}, Rain Total: {rain_inches:.3f}, Wind: {wind_speed:.2f}, Gust: {wind_gust:.2f}\n"
...
#        print(f"rain_total: {sensordata.rain_total}")
